...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        fetch('https://api.exchangeratesapi.io/latest?base=INR', {
            ...
            _this.currency = [{ rate: response.rates.USD, type: 'USD' }, { rate: response.rates.GBP, type: 'GBP' }, { rate: response.rates.EUR, type: 'EUR' }];
        }).catch(function (err) {
            console.log(err);
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Currency Converter")]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "wrapper" },
        _vm._l(_vm.currency, function(curr) {
          return _c(
            "div",
            { key: curr.type, staticClass: "card-div ml-2 mr-2 mb-3" },
            [
              _c(
                "card",
                ...
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "text-black mt-6 mb-6 text-2xl text-90 font-light currency"
                    },
                    [
                      _vm._v("\n                    INR : 1 "),
                      _c("br"),
